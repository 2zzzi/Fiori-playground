		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight Info - Fragment",
									"targetURL": "#sync4zfc1723-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4zfc1723-display": {
								"semanticObject": "sync4zfc1723",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.zfc1723",
									"url": sap.ui.require.toUrl("sync4/zfc1723")
								}
							}
						}
					}
