		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Layout Demo",
									"targetURL": "#sync4zfc1720-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4zfc1720-display": {
								"semanticObject": "sync4zfc1720",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.zfc1720",
									"url": sap.ui.require.toUrl("sync4/zfc1720")
								}
							}
						}
					}
