		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Layout",
									"targetURL": "#sync4zfc17071-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4zfc17071-display": {
								"semanticObject": "sync4zfc17071",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.zfc17071",
									"url": sap.ui.require.toUrl("sync4/zfc17071")
								}
							}
						}
					}
