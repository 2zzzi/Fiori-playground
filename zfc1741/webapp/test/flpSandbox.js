		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Combo Box",
									"targetURL": "#sync4zfc1741-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4zfc1741-display": {
								"semanticObject": "sync4zfc1741",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.zfc1741",
									"url": sap.ui.require.toUrl("sync4/zfc1741")
								}
							}
						}
					}
