		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Simple Form",
									"targetURL": "#sync4zfc1710-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4zfc1710-display": {
								"semanticObject": "sync4zfc1710",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.zfc1710",
									"url": sap.ui.require.toUrl("sync4/zfc1710")
								}
							}
						}
					}
