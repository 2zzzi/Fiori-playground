		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Binding Demo2",
									"targetURL": "#sync4zfc1750-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4zfc1750-display": {
								"semanticObject": "sync4zfc1750",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.zfc1750",
									"url": sap.ui.require.toUrl("sync4/zfc1750")
								}
							}
						}
					}
