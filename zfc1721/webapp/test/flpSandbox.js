		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fragment",
									"targetURL": "#sync4zfc1721-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4zfc1721-display": {
								"semanticObject": "sync4zfc1721",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.zfc1721",
									"url": sap.ui.require.toUrl("sync4/zfc1721")
								}
							}
						}
					}
