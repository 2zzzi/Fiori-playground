		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Student Info",
									"targetURL": "#sync4zfc1731-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4zfc1731-display": {
								"semanticObject": "sync4zfc1731",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.zfc1731",
									"url": sap.ui.require.toUrl("sync4/zfc1731")
								}
							}
						}
					}
