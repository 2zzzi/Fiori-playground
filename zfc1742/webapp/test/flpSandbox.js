		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Binding Demo",
									"targetURL": "#sync4zfc1742-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4zfc1742-display": {
								"semanticObject": "sync4zfc1742",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.zfc1742",
									"url": sap.ui.require.toUrl("sync4/zfc1742")
								}
							}
						}
					}
