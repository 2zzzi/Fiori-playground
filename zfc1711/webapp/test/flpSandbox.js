		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Airline Info",
									"targetURL": "#sync4zfc1711-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4zfc1711-display": {
								"semanticObject": "sync4zfc1711",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.zfc1711",
									"url": sap.ui.require.toUrl("sync4/zfc1711")
								}
							}
						}
					}
